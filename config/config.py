...
def init_config():
    ...
    cs.store(group='model', name="resnet18", node=ResNet18ModelConfig)
    cs.store(group='model', name="resnet34", node=ResNet18ModelConfig)
    cs.store(group='model', name="resnet50", node=ResNet18ModelConfig)
    cs.store(group='model', name="resnet101", node=ResNet18ModelConfig)
    cs.store(group='model', name="resnet152", node=ResNet18ModelConfig)
    ...
    cs.store(group='dataset', name="roi_single", node=ROIDatasetConfig)
    cs.store(group='dataset', name="cla4_single", node=Cla4SingleFoldDatasetConfig)
    cs.store(group='dataset', name="cla_weighted", node=ClaWeightedConfig)
