...
if __name__ == '__main__':
    ...
    for transform in selected_transforms:
        # Preprocess(transform, ratio=ratio,official_train=False,BUS=False,USG=False,fea_official_train=True).process_image()
        Preprocess(transform, ratio=ratio,official_train=True,BUS=True,USG=True,fea_official_train=False).process_image()
    ...
    for mixup_name in mixup_transforms:
        ...
        MixUp(alpha, ratio=mixup_ratio,official_train=False,BUS=False,USG=False,fea_official_train=True).process_image()
